...
class RuanganController extends Controller {
	...
	public function create() {
		...
		Helper::createOption('gedung-api', true)->pluck('name', 'id');
	...
	function list() {
		if (request()->isMethod('POST')) {
			...
			$datatable->editColumn('gedung_name', function ($select) {
				if (!empty($select->gedung)) {
					return $select->gedung->name;
				}
			});
